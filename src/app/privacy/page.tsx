      ...
      <section className="container mx-auto px-4 sm:px-6 max-w-4xl relative z-10">
        ...
        <div className="prose prose-invert max-w-none space-y-6 sm:space-y-10">
          <div className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-primary-text">1. Introduction</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">2. Information We Collect</h2>
            ...
            <ul className="list-disc list-inside text-muted-text space-y-2 pl-4">
              <li><strong className="text-primary-text">Contact Information:</strong> Name, email address, phone number and company name when you submit our contact form or reach out to us directly.</li>
              <li><strong className="text-primary-text">Project Details:</strong> Information about your business, marketing goals and project requirements that you share with us during consultations.</li>
              <li><strong className="text-primary-text">Usage Data:</strong> Information about how you interact with our website, including pages visited, time spent, referring URLs, browser type and device information.</li>
              <li><strong className="text-primary-text">Cookies & Analytics:</strong> We use cookies and similar tracking technologies to improve your browsing experience and understand site performance.</li>
            </ul>
          </div>

          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">3. How We Use Your Information</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">4. Data Sharing</h2>
            <p className="text-muted-text leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">5. Data Security</h2>
            <p className="text-muted-text leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">6. Data Retention</h2>
            <p className="text-muted-text leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">7. Your Rights</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">8. Cookies</h2>
            <p className="text-muted-text leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">9. Third-Party Links</h2>
            <p className="text-muted-text leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary-text">10. Changes to This Policy</h2>
            <p className="text-muted-text leading-relaxed">
